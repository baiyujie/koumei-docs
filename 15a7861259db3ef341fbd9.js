...
exports.name = 'component-api-notification-notification';
...
avalon.define({
    $id: 'doc-notification-basic',
    info: function () {
        koumei_1.notification.info({
            message: '这是一条普通通知',
            title: '通知'
        });
    },
    success: function () {
        koumei_1.notification.success({
            message: '这是一条成功通知',
            title: '通知'
        });
    },
    error: function () {
        koumei_1.notification.error({
            message: '这是一条失败通知',
            title: '通知'
        });
    },
    warning: function () {
        koumei_1.notification.warn({
            message: '这是一条警告通知',
            title: '通知'
        });
    }
